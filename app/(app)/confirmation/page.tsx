...
import { Plus, Upload, Search, Eye, Bell } from "lucide-react";
    ...
    <div className="flex-1 flex flex-col">
      ...
      <div className="p-4 sm:p-8">
        <div className="mb-6 relative">
          ...
          <input
            type="text"
            placeholder="Search by name, bishop, or parish..."
            value={search}
          ...
          <table className="w-full text-sm">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                ...
                <th className="text-left px-5 py-3 font-semibold text-gray-600 hidden md:table-cell">Bishop</th>
                <th className="text-left px-5 py-3 font-semibold text-gray-600 hidden md:table-cell">Saint Name</th>
                <th className="text-left px-5 py-3 font-semibold text-gray-600 hidden lg:table-cell">Sponsor</th>
                <th className="text-center px-5 py-3 font-semibold text-gray-600 hidden sm:table-cell">Notification</th>
            ...
            <tbody className="divide-y divide-gray-50">
              ...
              {records.map((r) => (
                <tr key={r.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-5 py-4 text-gray-500 hidden md:table-cell">{r.confirmingBishop}</td>
                  <td className="px-5 py-4 text-gray-500 italic hidden md:table-cell">{r.confirmationSaintName}</td>
                  <td className="px-5 py-4 text-gray-500 hidden lg:table-cell">{r.sponsorName}</td>
